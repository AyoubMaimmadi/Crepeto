...
const inventories = require('../data/inventories1.json')
const fs = require('fs')
const { v4: uuidv4 } = require('uuid')

//get all inventory
router.get('/inventory1', (_req, res) => {
  res.status(200).json(inventories)
})

//get single inventory info
router.get('/inventory1/:inventory1Id', (req, res) => {
...
router.post('/inventory1/add', (req, res) => {
  const {
    warehouseID,
    status,
    warehouseName,
...
router.delete('/inventory1/:inventory1Id', (req, res) => {
  const { inventoryId } = req.params
  const selectedInventory = inventories.findIndex(
  ...
  fs.writeFile(__dirname + '/../data/inventories1.json', dataObject, (err) => {
    console.log(err)
  })
...
router.put('/inventory1/:inventory1Id/edit', (req, res) => {
