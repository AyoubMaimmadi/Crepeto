...
export const addItem = (name, unitCost, unitPrice, qty) => ({
  type: 'ADD_ITEM',
  id: v4(),
  name,
  unitCost,
...
export const editItem = (id, name, unitCost, unitPrice, qty) => ({
  type: 'EDIT_ITEM',
  id,
  name,
  unitCost,
...
export const addHistory = (id, name, qty, status, date) => ({
  type: 'ADD_HISTORY',
  id: v4(),
  name,
  qty,
...
export const addSalesItem = (item_id, qty, price, amount) => ({
  type: 'ADD_SALES_ITEM',
  id: v4(),
  item_id,
  qty,
...
export const editSalesItemQty = (id, qty) => (dispatch, getState) => {
  ...
  dispatch({ type: 'EDIT_SALES_ITEM_QTY', id, qty })
  dispatch({
    type: 'EDIT_SALES_ITEM_AMOUNT',
    id,
    amount: salesItem.price * qty,
  })
}

export const editSalesItemPrice = (id, price) => ({
  type: 'EDIT_SALES_ITEM_PRICE',
  id,
  price,
})

export const editSalesItemAmount = (id, amount) => ({
  type: 'EDIT_SALES_ITEM_AMOUNT',
  id,
  amount,
})
...
export const editNewInvoiceCustomerName = (customerName) => ({
  type: 'EDIT_NEW_INVOICE_CUSTOMER_NAME',
  customerName,
})
export const editNewInvoiceCustomerPhone = (customerPhone) => ({
  type: 'EDIT_NEW_INVOICE_CUSTOMER_PHONE',
  customerPhone,
})

export const editNewInvoiceSelectCustomer =
  (selected) => (dispatch, getState) => {
